...
export const BUTTON_SIZE_STYLE = {
    ...
    medium: "px-3 py-2 text-[16px] font-pretendard-medium leading-[22px] tracking-wide",
    large: "px-5 py-3 text-xl font-pretendard-semibold leading-[22px] tracking-wide",
};
